...
class LC18_1CH_GUI(tk.Frame):
    def __init__(self, master, dll_LC18, light_conn_status, firmware_model_sel, firmware_version_str, infinity_icon
        ...
        self.channel_1_save[3] = 100     #Strobe Width Default
        self.channel_1_save[5] = 100     #Output Width Default
        self.channel_1_save[7] = 0       #board address index in integer
    ...
    def LC18_interface(self):
        ...
        self.ch_sel_btn1 = tk.Button(self, relief = tk.GROOVE, text = 'Channel 1', width = 12, font='Helvetica 11 bold')
    ...
    def channel_on_select(self):
        ...
        widget_enable(self.sel_1_checkbox)

        if self.ch_sel_str == '1 - 4':
            self.board_address()
            self.channel_1_save[7] = self.addr_index_a
