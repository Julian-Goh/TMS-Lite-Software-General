...
from LC18KP_pylib import LC18KP_Control
...
class LC18_KP_GUI(tk.Frame):
    def __init__(self, master, scroll_class, dll_LC18
        ...
        self.ctrl = LC18KP_Control(self.dll_LC18)
        # print(self.ctrl)
    ...
    def board_addr_gui(self):
        ...
        addr_0_chbox = tk.Checkbutton(addr_prnt, bg = addr_bg, activebackground = addr_bg)
        addr_1_chbox = tk.Checkbutton(addr_prnt, bg = addr_bg, activebackground = addr_bg)
        addr_2_chbox = tk.Checkbutton(addr_prnt, bg = addr_bg, activebackground = addr_bg)
        addr_3_chbox = tk.Checkbutton(addr_prnt, bg = addr_bg, activebackground = addr_bg)
        ...
        widget_disable(addr_0_chbox, addr_1_chbox, addr_2_chbox, addr_3_chbox)
