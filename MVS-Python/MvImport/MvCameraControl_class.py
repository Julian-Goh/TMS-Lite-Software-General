...
# mv_dll_path = os.getcwd() + "\\Win64_x64\\" + "MvCameraControl.dll" #os.getcwd() + "\\" + "MvCameraControl.dll"
# print(mv_dll_path)
# print(os.path.isfile(mv_dll_path))

# print(os.getcwd())
# mv_dll_path = os.getcwd() + "\\" + "MvCameraControl.dll"
MvCamCtrldll = WinDLL("MvCameraControl.dll")

# MvCamCtrldll = cdll.LoadLibrary(mv_dll_path)
#print(dir(MvCamCtrldll.MV_CC_EnumDevices))
# 用于回调函数传入相机实例
...
class MvCamera():
    ...
    def MV_CC_OpenDevice(self, nAccessMode=MV_ACCESS_Exclusive, nSwitchoverKey=0):
        ...
        # print('open device handle: ', self.handle)
    ...
    def MV_CC_CloseDevice(self):
        ...
        # print('close device handle: ', self.handle)
    ...
    def MV_CC_StopGrabbing(self):
        ...
        # print('stop grab handle: ', self.handle)
    ...
    def MV_CC_GetBalanceRatioRed(self, pstValue):
        MvCamCtrldll.MV_CC_GetBalanceRatioRed.argtype = (c_void_p, c_void_p)
        MvCamCtrldll.MV_CC_GetBalanceRatioRed.restype = c_uint

        return MvCamCtrldll.MV_CC_GetBalanceRatioRed(self.handle, byref(pstValue))

    def MV_CC_GetBalanceRatioGreen(self, pstValue):
        MvCamCtrldll.MV_CC_GetBalanceRatioGreen.argtype = (c_void_p, c_void_p)
        MvCamCtrldll.MV_CC_GetBalanceRatioGreen.restype = c_uint

        return MvCamCtrldll.MV_CC_GetBalanceRatioGreen(self.handle, byref(pstValue))

    def MV_CC_GetBalanceRatioBlue(self, pstValue):
        MvCamCtrldll.MV_CC_GetBalanceRatioBlue.argtype = (c_void_p, c_void_p)
        MvCamCtrldll.MV_CC_GetBalanceRatioBlue.restype = c_uint

        return MvCamCtrldll.MV_CC_GetBalanceRatioBlue(self.handle, byref(pstValue))

    def MV_CC_SetBalanceRatioRed(self, nValue):
        MvCamCtrldll.MV_CC_SetBalanceRatioRed.argtype = (c_void_p, c_uint)
        MvCamCtrldll.MV_CC_SetBalanceRatioRed.restype = c_uint

        return MvCamCtrldll.MV_CC_SetBalanceRatioRed(self.handle, c_uint(nValue))

    def MV_CC_SetBalanceRatioGreen(self, nValue):
        MvCamCtrldll.MV_CC_SetBalanceRatioGreen.argtype = (c_void_p, c_uint)
        MvCamCtrldll.MV_CC_SetBalanceRatioGreen.restype = c_uint

        return MvCamCtrldll.MV_CC_SetBalanceRatioGreen(self.handle, c_uint(nValue))

    def MV_CC_SetBalanceRatioBlue(self, nValue):
        MvCamCtrldll.MV_CC_SetBalanceRatioBlue.argtype = (c_void_p, c_uint)
        MvCamCtrldll.MV_CC_SetBalanceRatioBlue.restype = c_uint

        return MvCamCtrldll.MV_CC_SetBalanceRatioBlue(self.handle, c_uint(nValue))